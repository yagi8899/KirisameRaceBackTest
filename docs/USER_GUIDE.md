...
#### 7-4. 的中率分析グラフ
競馬場・距離・馬場・年度・月別の的中率を棒グラフで表示します。

**5つの分析モード**:
1. **競馬場別**: どの競馬場で的中率が高いか
2. **距離別**: 短距離（1000-1600m）vs 長距離（1700m以上）
3. **馬場別**: 芝 vs ダート
4. **年度別**: 年ごとの安定性確認
5. **月別**: 季節性・月次傾向の分析（春・夏・秋・冬の違い）

**活用例**:
- 4月の的中率が65%、8月が35% → 春競馬重視
- 芝85%、ダート45% → 芝専門で勝負
